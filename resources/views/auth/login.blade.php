<!DOCTYPE html>
                      ...
                      <title>Go Digital Admin Login</title>
                      ...
                      <body>
                        <section>
                          ...
                          <div class="imgBx" style="margin-top: 4%">
                            ...
                            <img src="{{asset('frontend/img/logo.png')}}" alt="Go Digital Africa Logo" style="height: 380px">
                            
                          </div>
                         
                          <div class="contentBx" style="width: 80%">
                              <div class="formBx ">
                                <h1>Go Digital Africa Admin Portal</h1>
                                <div class="col-4">
